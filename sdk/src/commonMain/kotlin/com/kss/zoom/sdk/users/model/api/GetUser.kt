...
import com.kss.zoom.sdk.users.model.domain.UserStatus
import com.kss.zoom.sdk.users.model.domain.PhoneNumber as DomainPhoneNumber
...
fun GetUser.toDomain(): UserInfo {
    return UserInfo(
        ...
        status = this.status?.let { UserStatus.fromString(it) },
...
fun GetUser.PhoneNumber.toDomain(): DomainPhoneNumber {
    return DomainPhoneNumber(
        code = this.code,
